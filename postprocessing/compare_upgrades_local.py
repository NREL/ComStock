...
def main():
    ...
    comstock = cspp.ComStock(
        s3_base_dir='',  # If run not on S3, download results_up**.parquet manually
        local_base_dir='C:/Scratch/comstock/efforts',
        comstock_run_name='schoolvav_occ_vav_mdp_upgrade',  # Name of the run on S3
        comstock_run_version='occ_mdp',  # Use whatever you want to see in plot and folder names
        comstock_year=2018,  # Typically don't change this
        truth_data_version='v01',  # Typically don't change this
        buildstock_csv_name='buildstock_20231009_v22_2018_eringold_schoolvav_single.csv',  # Download buildstock.csv manually
