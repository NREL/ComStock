...
class NamingMixin():
    ...
    UTIL_ELEC_BILL_VALS = [
        ...
        'out.utility_bills.electricity_bill_min_demandcharge..usd',
        'out.utility_bills.electricity_bill_min_label_demandcharge',
        'out.utility_bills.electricity_bill_max_demandcharge..usd',
        'out.utility_bills.electricity_bill_max_label_demandcharge',
        'out.utility_bills.electricity_bill_median_low_demandcharge..usd',
        'out.utility_bills.electricity_bill_median_low_label_demandcharge',
        'out.utility_bills.electricity_bill_median_high_demandcharge..usd',
        'out.utility_bills.electricity_bill_median_high_label_demandcharge',
        'out.utility_bills.electricity_bill_mean_demandcharge..usd',
        'out.utility_bills.electricity_bill_min_tou..usd',
        'out.utility_bills.electricity_bill_min_label_tou',
        'out.utility_bills.electricity_bill_max_tou..usd',
        'out.utility_bills.electricity_bill_max_label_tou',
        'out.utility_bills.electricity_bill_median_low_tou..usd',
        'out.utility_bills.electricity_bill_median_low_label_tou',
        'out.utility_bills.electricity_bill_median_high_tou..usd',
        'out.utility_bills.electricity_bill_median_high_label_tou',
        'out.utility_bills.electricity_bill_mean_tou..usd',
        'out.utility_bills.electricity_bill_min_energycharge..usd',
        'out.utility_bills.electricity_bill_min_label_energycharge',
        'out.utility_bills.electricity_bill_max_energycharge..usd',
        'out.utility_bills.electricity_bill_max_label_energycharge',
        'out.utility_bills.electricity_bill_median_low_energycharge..usd',
        'out.utility_bills.electricity_bill_median_low_label_energycharge',
        'out.utility_bills.electricity_bill_median_high_energycharge..usd',
        'out.utility_bills.electricity_bill_median_high_label_energycharge',
        'out.utility_bills.electricity_bill_mean_energycharge..usd',
