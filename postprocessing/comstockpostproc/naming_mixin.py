...
class NamingMixin():
    ...
    ANN_PROPANE_HVAC_GROUP_KBTU = 'calc.enduse_group.heating.energy_consumption..kwh'
    ANN_PROPANE_SWH_GROUP_KBTU = 'calc.enduse_group.water_systems.energy_consumption..kwh'
    ANN_PROPANE_INTEQUIP_GROUP_KBTU = 'calc.enduse_group.interior_equipment.energy_consumption..kwh'

    # End use group energy - fuel oil
    ANN_FUELOIL_HVAC_GROUP_KBTU = 'calc.enduse_group.heating.energy_consumption..kwh'
    ANN_FUELOIL_SWH_GROUP_KBTU = 'calc.enduse_group.water_systems.energy_consumption..kwh'
    ANN_FUELOIL_INTEQUIP_GROUP_KBTU = 'calc.enduse_group.interior_equipment.energy_consumption..kwh'
