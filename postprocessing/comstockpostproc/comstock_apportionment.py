...
class Apportion(NamingMixin, UnitsMixin, S3UtilitiesMixin):
    def __init__(self, stock_estimation_version, truth_data_version, bootstrap_coefficient=3, reload_from_cache=False, output_dir=None, aws_profile_name=None):
        ...
        self.hvac_system_type_name = 'hvac_system_type_v5.tsv'   # 2026-09: rebuilt from CBECS 2012+2018 (stock-estimation cbecs_hvac_tsvs); upload from sampling/tsvs/tsvs-v34.zip
        self.space_heating_fuel_type_name = 'heating_fuel_v3.tsv'   # 2026-09: rebuilt, county-level, raked to pooled CBECS division targets
