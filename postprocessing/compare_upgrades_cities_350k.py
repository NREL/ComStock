...
def main():
    ...
    comstock = cspp.ComStock(
        ...
        comstock_run_name='gto_all_measures_350k',  # Name of the run on S3
        comstock_run_version='gto_all_measures_350k',  # Use whatever you want to see in plot and folder names
