...
def main():
    ...
    # comstock.export_monthly()
    comp = cspp.ComStockToEIAComparison(eia_list, comstock_list, upgrade_id='All',make_comparison_plots=True)
    # comp.monthly_data.write_csv(os.path.join(comstock.output_dir, 'monthly.csv'))
