...
def main():
    ...
    comstock = cspp.ComStock(
        s3_base_dir='eulp/eusscom',  # If run not on S3, download results_up**.parquet manually
        comstock_run_name='dcv_10k_test5',  # Name of the run on S3
        comstock_run_version='dcv_10k_test5',  # Use whatever you want to see in plot and folder names
