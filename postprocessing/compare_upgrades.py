...
def main():
    ...
    comstock = cspp.ComStock(
        ...
        comstock_run_name='euss3_hprtu_erv_10k_V0',  # Name of the run on S3
        comstock_run_version='euss3_hprtu_erv_10k_V0',  # Use whatever you want to see in plot and folder names
