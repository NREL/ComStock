...
def main():
    ...
    comstock = cspp.ComStock(
        ...
        upgrade_ids_for_comparison={"comparison":[0,1,2]} # Use {'<Name you want for comparison run folder>':[0,1,2]}; add as many upgrade IDs as needed, but plots look strange over 5
        )
