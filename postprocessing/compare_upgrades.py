...
def main():
    ...
    comstock = cspp.ComStock(
        ...
        comstock_run_name='ComStock euss_cycle3_baseline_comparison',  # Name of the run on S3
        comstock_run_version='ComStock euss_cycle3_baseline_comparison',  # Use whatever you want to see in plot and folder names
        ...
        upgrade_ids_for_comparison={'comp':[0,1]} # Use {'<Name you want for comparison run folder>':[0,1,2]}; add as many upgrade IDs as needed, but plots look strange over 5
        )
