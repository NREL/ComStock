...
def main():
    ...
    comstock = cspp.ComStock(
        ...
        comstock_run_name='utility_bills_plot_testing',  # Name of the run on S3
        comstock_run_version='utility_bills_plot_testing',  # Use whatever you want to see in plot and folder names
