...
def main():
    ...
    comstock = cspp.ComStock(
        ...
        comstock_run_name='loadshed_fullbaseline_10k_v0',  # Name of the run on S3
        comstock_run_version='shiftfb10k',  # Use whatever you want to see in plot and folder names
        comstock_year=2018,  # Typically don't change this
        athena_table_name=None,  # Typically don't change this
        truth_data_version='v01',  # Typically don't change this
        buildstock_csv_name='buildstock_20240117_v23_2018_mprapros_10000_hardsize.csv',  # Download buildstock.csv manually
