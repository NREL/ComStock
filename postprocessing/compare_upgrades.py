...
def main():
    ...
    comstock = cspp.ComStock(
        ...
        comstock_run_name='lightemission10kn',  # Name of the run on S3
        comstock_run_version='lightemission10kn',  # Use whatever you want to see in plot and folder names
        comstock_year=2018,  # Typically don't change this
        athena_table_name=None,  # Typically don't change this
        truth_data_version='v01',  # Typically don't change this
        buildstock_csv_name='buildstock_11079_sampling_v2_tester.csv',  # Download buildstock.csv manually
        ...
        upgrade_ids_for_comparison={'compare':[0,1]} # Use {'<Name you want for comparison run folder>':[0,1,2]}; add as many upgrade IDs as needed, but plots look strange over 5
        )
