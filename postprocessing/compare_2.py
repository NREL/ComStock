...
def main():
    ...
    comstock = cspp.ComStock(
        ...
        comstock_run_name='hprtu_w_roof_11079_10',  # Name of the run on S3
        comstock_run_version='hprtu_w_roof_11079_10',  # Use whatever you want to see in plot and folder names
