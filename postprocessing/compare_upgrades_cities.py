...
def main():
    ...
    comstock = cspp.ComStock(
        ...
        comstock_run_name='gto_all_measures_10k_3',  # Name of the run on S3
        comstock_run_version='gto_all_measures_10k_3',  # Use whatever you want to see in plot and folder names
        ...
        states={
                ...
                'G2500250':'Boston, Massachusetts',
                'G0400130': 'Phoenix, Arizona',
                'G2700530': 'Minneapolis, Minnesota',
                #'AZ': 'Arizona',
                #'TN': 'Tennessee'
                },
        upgrade_ids_for_comparison={'Packaged GHP vs ASHP PSZ Only':[0,1,5,6]}
        )
