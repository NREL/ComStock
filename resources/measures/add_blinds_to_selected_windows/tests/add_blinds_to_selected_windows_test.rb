...
class AddBlindsToSelectedWindowsTest < Minitest::Test
  ...
  def test_models
    ...
    models_to_test = []
    models_to_test << { model: 'example_OfL_model', weather: 'CA_LOS-ANGELES-DOWNTOWN-USC_722874S_16', result: 'Success' }
    ...
    models_to_test.each do |set|
      ...
      if argument_map['add_blinds'].hasDefaultValue
        assert(blinds_area > 0)
      elsif !argument_map['add_blinds'].valueAsBool
