...
class SetInteriorLightingBPRTest < Minitest::Test
  ...
  def models_to_test
    ...
    test_sets << {
      model: 'Warehouse_5A',
      weather: 'MI_DETROIT_725375_12', result:
      'Success',
      expected_hrly_vals: [[2, 0], [10, 0.9], [19, 0.9], [23, 0]],
      expected_hrly_vals2: [[2, 0.81], [10, 0.9], [19, 0.9], [23, 0.81]],
    ...
    test_sets << {
      ...
      weather: 'MI_DETROIT_725375_12',
      result: 'Success',
      expected_hrly_vals: [[2, 0], [12, 0.9], [17, 0.9]],
      expected_hrly_vals2: [[2, 0.81], [15, 0.9], [17, 0.9], [21, 0.868235294117647]],
    ...
    test_sets << {
      ...
      weather: 'MI_DETROIT_725375_12',
      result: 'Success',
      expected_hrly_vals: [[4, 0.0], [6, 0.63], [12, 0.9], [23, 0.9]],
      expected_hrly_vals2: [[4, 0.81], [12, 0.9], [16, 0.9], [24, 0.873]],
