...
class ReplaceBaselineWindowsTest < Minitest::Test
  ...
  def test_number_of_arguments_and_argument_names
    ...
    assert_equal('window_pane_type', arguments[0].name)
    assert_equal('u_value_ip', arguments[1].name)
    assert_equal('shgc', arguments[2].name)
    assert_equal('vlt', arguments[3].name)
  end
