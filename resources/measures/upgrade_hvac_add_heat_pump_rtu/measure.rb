    ...
    selected_air_loops.sort.each do |air_loop_hvac|
      ...
      if std_perf
        if cchpc == 'scenario_1' || cchpc == 'scenario_2' || cchpc == 'scenario_3'
          ...
          rated_cop_fit = final_rated_cooling_cop
        end
      ...
      if std_perf
        ...
        new_dx_heating_coil.setMinimumOutdoorDryBulbTemperatureforCompressorOperation()
        if cchpc == 'scenario_1' || cchpc == 'scenario_4'
          ...
          compress_lockout_temp = OpenStudio.convert(hp_min_comp_lockout_temp_f, 'F', 'C').get
        end
        ...
        if cchpc == 'scenario_1' || cchpc == 'scenario_4'
          ...
          rated_cop_fit = final_rated_heating_cop
        end
