...
class SetExteriorLightingTemplateTest < Minitest::Test
  ...
  def test_lighting_changes_hotel
    # create an instance of the measure
    measure = SetExteriorLightingTemplate.new
    ...
    # load the test model
    translator = OpenStudio::OSVersion::VersionTranslator.new
    path = "#{File.dirname(__FILE__)}/htl_test.osm"
    model = translator.loadModel(path)
    assert(!model.empty?)
    model = model.get
  ...
  def test_lighting_changes_hospital
    # create an instance of the measure
    measure = SetExteriorLightingTemplate.new
    ...
    # load the test model
    translator = OpenStudio::OSVersion::VersionTranslator.new
    path = "#{File.dirname(__FILE__)}/hsp_test.osm"
    model = translator.loadModel(path)
    assert(!model.empty?)
    model = model.get
  ...
  def test_lighting_changes_fastfood
    # create an instance of the measure
    measure = SetExteriorLightingTemplate.new
    ...
    # load the test model
    translator = OpenStudio::OSVersion::VersionTranslator.new
    path = "#{File.dirname(__FILE__)}/rff_test.osm"
    model = translator.loadModel(path)
    assert(!model.empty?)
    model = model.get
  ...
  def test_lighting_changes_fastfood_nondeer
    # create an instance of the measure
    measure = SetExteriorLightingTemplate.new
