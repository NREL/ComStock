...
# start the measure
class UpgradePump < OpenStudio::Measure::ModelMeasure
  # human readable name
  def name
    return "upgrade_pump"
  end
  ...
  def run(model, runner, user_arguments)
    ...
    results_before = UpgradePump.chiller_specifications(applicable_chillers)
    ...
    pump_specs_cst_spd_before = UpgradePump.pump_specifications(applicable_pumps, pumps_const_spd, std)
    ...
    pump_specs_var_spd_before = UpgradePump.pump_specifications(applicable_pumps, pumps_var_spd, std)
    ...
    # ------------------------------------------------
    chw_oat_reset_enabled_before = UpgradePump.control_specifications(model)
    if debug_verbose
      runner.registerInfo('### ------------------------------------------------------')
    ...
    results_after = UpgradePump.chiller_specifications(upgraded_chillers)
    ...
    # get control specifications before upgrade
    # ------------------------------------------------
    chw_oat_reset_enabled_after = UpgradePump.control_specifications(model)
    if debug_verbose
      runner.registerInfo('### ------------------------------------------------------')
...
UpgradePump.new.registerWithApplication
