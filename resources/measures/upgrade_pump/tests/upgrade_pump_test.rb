...
class UpgradePumpTest < Minitest::Test
  ...
  def apply_and_test_model(path, instance_test_name)
    ...
    results_b = UpgradePump.chiller_specifications(chillers)
    ...
    pump_specs_cst_spd_before = UpgradePump.pump_specifications([], pumps_const_spd, std)
    ...
    pump_specs_var_spd_before = UpgradePump.pump_specifications([], pumps_var_spd, std)
    ...
    fraction_chw_oat_reset_enabled_b, fraction_cw_oat_reset_enabled_b = UpgradePump.control_specifications(model)
    ...
    chillers = model.getChillerElectricEIRs
    results_a = UpgradePump.chiller_specifications(chillers)
    ...
    pumps_const_spd = model.getPumpConstantSpeeds
    pump_specs_cst_spd_after = UpgradePump.pump_specifications([], pumps_const_spd, std)
    ...
    pumps_var_spd = model.getPumpVariableSpeeds
    pump_specs_var_spd_after = UpgradePump.pump_specifications([], pumps_var_spd, std)
    ...
    fraction_chw_oat_reset_enabled_a, fraction_cw_oat_reset_enabled_a = UpgradePump.control_specifications(model)
